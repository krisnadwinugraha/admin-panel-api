        ...
        <v-card-text class="pt-5">
          <v-row>
            <v-col cols="12" sm="8" md="6">
              ...
              <!-- Deskripsi -->
              <v-text-field v-model="Deskripsi" :type="'text'" label="Deskripsi" outlined dense></v-text-field>

              <!-- Harga -->
              <v-text-field v-model="Harga" :type="'number'" label="Harga" outlined dense></v-text-field>
            </v-col>

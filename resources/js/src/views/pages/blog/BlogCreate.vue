        ...
        <v-card-text class="pt-5">
          <v-row>
            <v-col cols="12" sm="8" md="6">
              ...
              <!-- Title -->
              <v-text-field v-model="Title" :type="'text'" label="Title" outlined dense></v-text-field>

              <!-- Category -->
              <v-text-field v-model="Category" :type="'text'" label="Category" outlined dense></v-text-field>

              <!-- Content -->
              <v-text-field v-model="Content" :type="'text'" label="Content" outlined dense></v-text-field>
            </v-col>
